...
const RightHeroPanel = ({ title, titleHighlight, subtitle, stats }) =>{
  return (
    <div className="relative hidden w-1/2 lg:block overflow-hidden bg-slate-900">
      {/* Background Image - Full Size & Professional Cover */}
      <img
        src="/illustration.jpg"
        alt="Skill Setu — Academia & Industry Collaboration"
        className="absolute inset-0 h-full w-full object-cover object-center filter brightness-90 contrast-[1.05]"
      />

      {/* Dynamic Modern Overlay Gradients */}
      <div className="absolute inset-0 bg-linear-to-t from-slate-950 via-slate-900/40 to-slate-900/20" />
      <div className="absolute inset-0 bg-linear-to-r from-navy-900/60 via-transparent to-slate-900/60" />
